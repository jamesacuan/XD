        ...
        <div class="modal-body form-horizontal">
            ...
            <div class="form-group" id="item_product">
                ...
                <div class="radio col-sm-9">
                        <label for="HH" class="radio-inline">
                            <input type="radio" value="HH" name="type" id="HH">Helmet Holder
                        </label>
                        <label for="TH" class="radio-inline">
                            <input type="radio" value="TH" name="type" id="TH">Ticket Holder
                        </label>
                    </div>
                </div>
            ...
            <div class="form-group" id="item_category">
                ...
                <div class="radio radio col-sm-9">
                        <label for="pln">
                            <input type="radio" value="plain" name="category" id="pln">Plain
                        </label>
                        <label for="csm">
                            <input type="radio" value="custom" name="category" id="csm">Custom
                        </label>
                    </div>
            </div>
            <div class="form-group" id="item_name">
                ...
                <div class="col-sm-9">
                    <select class="form-control input-sm" name="name" id="name"></select>
                    <i>Loading</i>
                </div>
            </div>
