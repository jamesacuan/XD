...
<script src="<?php echo $subdirectory ?>assets/js/jquery-ui.min.js"></script>
...
?>
<script src="<?php echo $subdirectory ?>assets/js/jquery.hotkeys.js"></script>
<script src="<?php echo $subdirectory ?>assets/js/script.js"></script>
